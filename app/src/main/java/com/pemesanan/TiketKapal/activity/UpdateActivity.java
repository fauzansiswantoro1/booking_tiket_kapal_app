...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtid = findViewById(R.id.idbook);
            ...
            public void onClick(View v) {
                ...
                if (sAsal != null && sTujuan != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("jakarta"))
                        ...
                        Toast.makeText(UpdateActivity.this, "Asal dan Tujuan tidak boleh sama !", Toast.LENGTH_LONG).show();
                    } else {
                        AlertDialog dialog = new AlertDialog.Builder(UpdateActivity.this)
                                .setTitle("Ingin Update Tiket?")
                                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        try {
                                            db.execSQL("UPDATE TB_BOOK SET  asal='" +
                                                    sAsal + "',tujuan='" +
                                                    sTujuan + "',tanggal='" +
                                                    sTanggal + "',dewasa='" +
                                                    sDewasa + "',anak='" +
                                            ...
                                            db.execSQL("UPDATE TB_HARGA SET username='" +
                                                    email + "',harga_dewasa='" +
                                                    hargaTotalDewasa + "',harga_anak='" +
                                                    hargaTotalAnak + "',harga_total='" +
                                                    hargaTotal + "'where id_book='" +
                                                    txtid + "'");
                    ...
                    Toast.makeText(UpdateActivity.this, "Mohon lengkapi data pemesanan!", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void setupToolbar() {
        Toolbar toolbar = findViewById(R.id.tbUpdate);
