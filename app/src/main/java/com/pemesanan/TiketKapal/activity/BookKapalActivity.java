...
import com.pemesanan.TiketKapal.session.SessionManager;

import java.util.Calendar;
import java.util.HashMap;

public class BookKapalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new DatabaseHelper(BookKapalActivity.this);
        db = dbHelper.getReadableDatabase();

        final String[] asal = {"Jakarta", "Medan", "Bali", "Lampung", "Surabaya"};
        final String[] tujuan = {"Jakarta", "Medan", "Bali", "Lampung", "Surabaya"};
            ...
            public void onClick(View v) {
                ...
                if (sAsal != null && sTujuan != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("jakarta"))
                        ...
                        Toast.makeText(BookKapalActivity.this, "Asal dan Tujuan tidak boleh sama !", Toast.LENGTH_LONG).show();
                    } else {
                        AlertDialog dialog = new AlertDialog.Builder(BookKapalActivity.this)
                                .setTitle("Ingin booking kapal sekarang?")
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        try {
                                            ...
                                            db.execSQL("INSERT INTO TB_HARGA (username, id_book, harga_dewasa, harga_anak, harga_total) VALUES ('" +
                                                    ...
                                                    hargaTotalAnak + "','" +
                                                    hargaTotal + "');");
                                            Toast.makeText(BookKapalActivity.this, "Booking berhasil", Toast.LENGTH_LONG).show();
                                            finish();
                                        } catch (Exception e) {
                                            Toast.makeText(BookKapalActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                                        }
                                    }
                                })
                    ...
                    Toast.makeText(BookKapalActivity.this, "Mohon lengkapi data pemesanan!", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 400000;
            hargaAnak = 250000;
            ...
            hargaDewasa = 150000;
            hargaAnak = 120000;
        } else if (sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("lampung")) {
            hargaDewasa = 180000;
            hargaAnak = 140000;
        } else if (sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("jakarta")) {
            hargaDewasa = 400000;
            hargaAnak = 250000;
        } else if (sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("surabaya")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("bali")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
            ...
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("surabaya") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("surabaya") && sTujuan.equalsIgnoreCase("bali")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("surabaya") && sTujuan.equalsIgnoreCase("lampung")) {
            hargaDewasa = 400000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("bali") && sTujuan.equalsIgnoreCase("jakarta")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
        } else if (sAsal.equalsIgnoreCase("bali") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
        } else if (sAsal.equalsIgnoreCase("bali") && sTujuan.equalsIgnoreCase("lampung")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("bali") && sTujuan.equalsIgnoreCase("surabaya")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("lampung") && sTujuan.equalsIgnoreCase("jakarta")) {
            hargaDewasa = 180000;
            hargaAnak = 140000;
        } else if (sAsal.equalsIgnoreCase("lampung") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 190000;
            hargaAnak = 160000;
        } else if (sAsal.equalsIgnoreCase("lampung") && sTujuan.equalsIgnoreCase("bali")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("lampung") && sTujuan.equalsIgnoreCase("surabaya")) {
            hargaDewasa = 400000;
            hargaAnak = 150000;
        }
